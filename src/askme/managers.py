...
class QuestionsManager:
    ...
    def update_database(self):
        # إعادة كتابة الملف بالكامل (يستخدم عند الحذف)
    ...
    def list_feed(self):
        ...
        print("\n--- Feed ---")
        for q in self.questions.values():
            if q.parent_id == -1: # عرض الأسئلة الأصلية فقط
